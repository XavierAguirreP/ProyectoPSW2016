...
require_once ('../paginas/ListarPersona.php');
...
$estado_civil = $_GET['estado_civil'];
	...
	$model->UpdatePersona($id ,$cedula_identidad ,$nombres ,$apellido_paterno ,$apellido_materno ,$fecha_nacimiento ,$lugar_nacimiento ,$sexo ,$estado_civil);

?>

<a href = "../paginas/ListarPersona.php">cunsultar</a>    
